<div class="row-fluid">
    <div class="span12">
        ...
        <table class="table table-bordered">
            <thead>
                <tr>
                    <th><?php echo __('Name', 'news'); ?></th>
                    <th><?php echo __('Author', 'news'); ?></th>
                    <th><?php echo __('Status', 'news'); ?></th>
                    <th><?php echo __('Hits', 'news'); ?></th>
                    <th><?php echo __('Date', 'news'); ?></th>
                    <th width="180"><?php echo __('Actions', 'news'); ?></th>
                </tr>
            </thead>
            <tbody>
                        ...
                        <div class="btn-group">
                            ...
                            echo (
                                Html::anchor(__('Edit', 'news'), 'index.php?id=news&action=edit&news_id='.$row['id'], 
                                    array('class' => 'btn btn-small')).Html::Nbsp(2).
