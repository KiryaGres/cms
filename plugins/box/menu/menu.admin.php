                ...
                switch (Request::get('action')) {
                    ...
                    case "edit":
                        ...
                        if (Request::post('menu_add_item')) {
                            ...
                            if (Security::check(Request::post('csrf'))) {
                                ...
                                if (trim(Request::post('menu_item_name')) == '') {
                                    ...
                                    if (Request::post('menu_item_description')) $menu_item_description = Request::post('menu_item_description'); else $menu_item_description = $item['description'];
                                    ...
                                    if (Request::post('menu_item_branch')) $menu_item_branch = Request::post('menu_item_branch'); else $menu_item_branch = $item['branch'];
                                ...
                                if (count($errors) == 0) {
                                    MenuAdmin::$menu->update(Request::get('item_id'),
                                                             array('name'        => Request::post('menu_item_name'),
                                                                   'description' => Request::post('menu_item_description'),
                                                                   ...
                                                                   'branch'      => Security::safeName(Request::post('menu_item_branch'), '-', true),
                        ...
                        View::factory('box/menu/views/backend/edit')
                                ...
                                ->assign('menu_item_description', $menu_item_description)
                                ...
                                ->assign('menu_item_branch', $menu_item_branch)
                        ...
                        if (Request::post('menu_add_item')) {
                            ...
                            if (Security::check(Request::post('csrf'))) {   
                                ...
                                if (trim(Request::post('menu_item_name')) == '') {
                                    ...
                                    if (Request::post('menu_item_description')) $menu_item_description = Request::post('menu_item_description'); else $menu_item_description = '';
                                    ...
                                    if (Request::post('menu_item_branch')) $menu_item_branch = Request::post('menu_item_branch'); else $menu_item_branch = '';
