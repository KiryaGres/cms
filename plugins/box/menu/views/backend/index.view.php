...
<?php
    ...
    foreach ($categories as $category) {
        ...
        $items = $menu->select('[category="'.$category.'"]', 'all', null, array('id', 'image', 'name', 'description', 'link', 'target', 'branch', 'order', 'category'), 'order', 'ASC');
...
<table class="table table-bordered">
    <thead>
        <tr>
            ...
            <td><?php echo __('Branch', 'menu'); ?></td>
            <td><?php echo __('Description', 'menu'); ?></td>
    ...
    <tbody>
        ...
        <?php
            ...
            $item['description'] = Html::toText($item['description']);
