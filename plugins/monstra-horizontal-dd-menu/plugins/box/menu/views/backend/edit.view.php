...
<?php 
    ...
    echo (
        Form::label('menu_item_description', __('Item description', 'menu')).
        Form::input('menu_item_description', $menu_item_description, array('class' => 'span3'))
    );
    ...
    echo (
        Form::label('menu_item_branch', __('Item branch', 'menu')).
        Form::input('menu_item_branch', $menu_item_branch, array('class' => 'span3'))
    );
?>
